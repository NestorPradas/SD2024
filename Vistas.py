...
class VistaInicial(tk.Frame):
    def __init__(self, master, vista_secundaria):
        tk.Frame.__init__(self, master)
        master.geometry("400x500")
        master.title("Vista Inicial")
...
class VistaSecundaria(tk.Frame):
    def __init__(self, master, volver_vista_inicial):
        tk.Frame.__init__(self, master)
        master.geometry("400x500")
        master.title("Vista Secundaria")
        ...
        boton_imprimir = tk.Button(self, text="Imprimir Texto", command=self.imprimir_texto)
